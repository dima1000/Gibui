...
static const char qt_meta_stringdata_CMapWidget[] = {
    "CMapWidget\0"
};
...
const QMetaObjectExtraData CMapWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CMapWidget::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_CMapWidget,
      qt_meta_data_CMapWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CMapWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CMapWidget))
        return static_cast<void*>(const_cast< CMapWidget*>(this));
